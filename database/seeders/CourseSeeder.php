...
/**
 * Catálogo real de capacitaciones corporativas. No es data de prueba — SÍ debe poder
 * correr en producción (`php artisan db:seed --class=CourseSeeder`): la precondición
 * automática "capacitaciones" de Súmate (SumateService::autoContext()) depende de que
 * exista al menos un curso `tag=Obligatorio` — si esta tabla queda vacía en producción,
 * la precondición se vuelve verdadera para todos sin haber completado nada.
 * Idempotente (updateOrCreate por id): correrlo de nuevo solo actualiza.
 */
